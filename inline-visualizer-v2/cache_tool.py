...
class Tools:
    ...
    async def cache_tool_call(
        ...
        result is found in native tool-loop history by tool_call_id and is never
        ...
        call_data, error = _find_latest_tool_call(messages, tool_id)
        if call_data is None:
            return {
                "status": "error",
                "error": error or "Tool call not found",
                "tool_id": tool_id,
            }
